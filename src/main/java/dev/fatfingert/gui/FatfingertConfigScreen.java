...
public class FatfingertConfigScreen extends Screen {
    ...
    public void render(GuiGraphics g, int mouseX, int mouseY, float delta) {
        // Unlike the 26.1 extract passes, super.render() paints the background
        // (our card) and *then* every widget, so all of our own chrome has to be
        // drawn afterwards or the card would cover it. Nothing here overlaps a
        // widget, so drawing it last looks identical.
